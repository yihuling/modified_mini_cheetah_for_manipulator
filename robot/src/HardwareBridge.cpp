...
//    Vec3<float> rpy=quatToRPY(_vectorNavData.quat);
//    Vec3<float> rpy0=quatToRPY(_microstrainImu.quat);
//
//    printf("rpy: %.3f %.3f %.3f\n",  rpy(0), rpy(1),rpy(2));
//    printf("rpy0: %.3f %.3f %.3f\n",  rpy0(0), rpy0(1),rpy0(2));
//    printf("quat: %.3f %.3f %.3f %.3f\n",_microstrainImu.quat[1],_microstrainImu.quat[2],_microstrainImu.quat[3],_microstrainImu.quat[0]);
