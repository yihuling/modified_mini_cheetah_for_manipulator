...
public:
  MIT_UserParameters()
      : ControlParameters("user-parameters"),
        ...
        INIT_PARAMETER(motion_jump_kp),
        INIT_PARAMETER(motion_jump_kd),
        INIT_PARAMETER(eucliddean_distance_radius),
        INIT_PARAMETER(target_com_info_1),
        INIT_PARAMETER(target_com_info_2),
        INIT_PARAMETER(obstacle_info_A),
        INIT_PARAMETER(obstacle_info_B),
        INIT_PARAMETER(obstacle_info_C),
        INIT_PARAMETER(obstacle_info_D),
  ...
  {}
  DECLARE_PARAMETER(Vec3<double>,motion_jump_kp);
  DECLARE_PARAMETER(Vec3<double>,motion_jump_kd);
  DECLARE_PARAMETER(Vec3<double>,eucliddean_distance_radius);
  DECLARE_PARAMETER(Vec3<double>,target_com_info_1);
  DECLARE_PARAMETER(Vec3<double>,target_com_info_2);
  DECLARE_PARAMETER(Vec3<double>,obstacle_info_A);
  DECLARE_PARAMETER(Vec3<double>,obstacle_info_B);
  DECLARE_PARAMETER(Vec3<double>,obstacle_info_C);
  DECLARE_PARAMETER(Vec3<double>,obstacle_info_D);
