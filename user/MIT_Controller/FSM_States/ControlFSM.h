...
#include "../FSM_States/FSM_State_Jump5TypesMotionOPT.h"
#include "../FSM_States/FSM_State_SitDown.h"
#include "../FSM_States/FSM_State_ArmControl.h"
...
//  FSM_State_FrontJump<T>* frontJump;
  ...
  FSM_State_Jump5TypesMotionOPT<T>* frontJumpOpt;
  FSM_State_SitDown<T>* sitDown;
  FSM_State_ArmControl<T>* armControl;
};
