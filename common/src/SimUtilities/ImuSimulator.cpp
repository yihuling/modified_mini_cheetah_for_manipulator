...
//  Vec3<float> rpy=quatToRPY(ori_quat);
//  printf("sim rpy: %.3f %.3f %.3f\n",  rpy(0), rpy(1),rpy(2));
//  printf("sim quat original: %.3f %.3f %.3f %.3f\n",ori_quat[0],ori_quat[1],ori_quat[2],ori_quat[3]);
//  printf("sim quat change to robot: %.3f %.3f %.3f %.3f\n",data->quat[0],data->quat[1],data->quat[2],data->quat[3]);
//  printf("sim acc: %.3f %.3f %.3f\n", data->accelerometer[0], data->accelerometer[1], data->accelerometer[2]);
//  printf("sim ang: %.3f %.3f %.3f\n",  data->gyro[0], data->gyro[1],  data->gyro[2]);
}
